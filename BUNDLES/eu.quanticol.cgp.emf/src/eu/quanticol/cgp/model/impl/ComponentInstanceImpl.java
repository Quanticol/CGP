 ...
 * </p>
 * <ul>
 *   <li>{@link eu.quanticol.cgp.model.impl.ComponentInstanceImpl#getPrototype <em>Prototype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentInstanceImpl extends LocatedElementImpl implements ComponentInstance {
	/**
	...
	protected EClass eStaticClass() {
		return CGPPackage.Literals.COMPONENT_INSTANCE;
	}
		...
		if (prototype != null && prototype.eIsProxy()) {
			...
			if (prototype != oldPrototype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CGPPackage.COMPONENT_INSTANCE__PROTOTYPE, oldPrototype, prototype));
			}
		}
		return prototype;
	}
	...
	public void setPrototype(ComponentPrototype newPrototype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CGPPackage.COMPONENT_INSTANCE__PROTOTYPE, oldPrototype, prototype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CGPPackage.COMPONENT_INSTANCE__PROTOTYPE:
