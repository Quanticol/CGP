...
/**
 * This is the item provider adapter for a {@link eu.quanticol.cgp.model.ComponentInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentInstanceItemProvider extends LocatedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentInstance_prototype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentInstance_prototype_feature", "_UI_ComponentInstance_type"),
				 CGPPackage.Literals.COMPONENT_INSTANCE__PROTOTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_ComponentInstance_type") + " " + componentInstance.getX();
	}
