...
public class CGPRectangleFigure extends Figure implements CGPFigure {
	private Label label;
	private IFigure figure;
	private ConnectionAnchor connectionAnchor;
   
	public CGPRectangleFigure() {
	...
	private IFigure buildFigure(){
		...
		myShape.addPoint(new Point(0,0));
		myShape.addPoint(new Point(10,0));
		myShape.addPoint(new Point(10,10));
		myShape.addPoint(new Point(0,10));
